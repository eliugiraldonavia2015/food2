...
struct RootView: View {
    ...
    var body: some View {
        ...
        .background(Color.white) // Fondo general del contenedor raíz
        ...
        var body: some View {
            ZStack {
                ...
                if let uiImage = loadSplashImage() {
                    ...
                    .offset(x: -10, y: -10) // Match LaunchScreen storyboard alignment
                }
            }
        }

        private func loadSplashImage() -> UIImage? {
            if let img = UIImage(named: "foodtook_isotipo_magenta") {
                return img
            }
